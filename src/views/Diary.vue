    ...
    <section class="wrapper">
      ...
      <ul class="todo-list">
        <li v-for="diary in diarys" :key="diary.id" class="todo-item">
          ...
          <div v-if="currentlyEditing !== diary.id">
            <button class="todo-button" @click.prevent="editDiary(diary)">edit</button>
            <button class="todo-button" @click.prevent="deleteDiary(diary.id)">del</button>
          </div>
...
export default {
  ...
  methods: {
    ...
    async editDiary(diary) {
      ...
      this.newTitle = diary.tile
      this.newStory = diary.story
